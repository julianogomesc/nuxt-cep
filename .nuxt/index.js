...
import nuxt_plugin_plugin_48eb3797 from 'nuxt_plugin_plugin_48eb3797' // Source: .\\components\\plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Pesquisa de CEP","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_48eb3797 === 'function') {
    await nuxt_plugin_plugin_48eb3797(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_ac37cb2e === 'function') {
    await nuxt_plugin_bootstrapvue_ac37cb2e(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_4940163a === 'function') {
    await nuxt_plugin_axios_4940163a(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_auth_56ea3894 === 'function') {
    await nuxt_plugin_auth_56ea3894(app.context, inject)
  }
